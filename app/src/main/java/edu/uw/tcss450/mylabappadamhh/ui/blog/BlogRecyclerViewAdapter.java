package edu.uw.tcss450.mylabappadamhh.ui.blog;
...
import edu.uw.tcss450.mylabappadamhh.databinding.FragmentBlogCardBinding;
...
public class BlogRecyclerViewAdapter extends
    ...
    public class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        private void handleMoreOrLess(final View button) {
            //Use view model to keep expanded!! TODO VM blog, but not part of lab
        ...
        void setBlog(final BlogPost blog) {
            ...
            {   Navigation.findNavController(mView).navigate(
                    BlogListFragmentDirections
                        .actionBlogListFragmentToBlogPostFragment(blog)
            );
            }
            );
